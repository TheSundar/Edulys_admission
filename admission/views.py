...
def save_data(request):
    ...
    student_first_name = 'Invalid' if re.findall('^[a-zA-Z]*[a-zA-Z]$',student_first_name) == [] else student_first_name
    student_middle_name = 'Invalid' if re.findall('^[a-zA-Z]*[a-zA-Z]$', student_middle_name) == [] else student_middle_name
